# DecisionTree Binary Classifier in PiML with Shapley explanations
## Project Description
...
- A **DecisionTree classifier** algorithm built using **PiML**
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the DecisionTree classifier model implemented using **Scikit-Learn** library.
